...
/* harmony import */ var _cometchat_pro_cordova_ionic_chat__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @cometchat-pro/cordova-ionic-chat */ "./node_modules/@cometchat-pro/cordova-ionic-chat/CometChat.js");
/* harmony import */ var _cometchat_pro_cordova_ionic_chat__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_cometchat_pro_cordova_ionic_chat__WEBPACK_IMPORTED_MODULE_6__);
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, toastCtrl, zoomService) {
        this.platform = platform;
        this.splashScreen = splashScreen;
        this.statusBar = statusBar;
        this.toastCtrl = toastCtrl;
        this.zoomService = zoomService;
        this.SDK_KEY = 'J8CXCoyt9nPZa237BVL02Cex4qZAoJAiQ6Vb';
        this.SDK_SECRET = 'fVqWIB2P1z5Nq3kAMGONrDQSALIcumhYj1o8';
        this.initializeApp();
    }
    AppComponent.prototype.initializeApp = function () {
        ...
        var region = "US";
        var appSetting = new _cometchat_pro_cordova_ionic_chat__WEBPACK_IMPORTED_MODULE_6__["CometChat"].AppSettingsBuilder().subscribePresenceForAllUsers().setRegion(region).build();
        _cometchat_pro_cordova_ionic_chat__WEBPACK_IMPORTED_MODULE_6__["CometChat"].init(appID, appSetting).then(function () {
            console.log("CometChat Initialization completed successfully");
            // You can now call login function.
            var apiKey = "b9f367608e4ae2b256b4432201db38803b1d040f";
            var uid = "user3";
            var name = "Dan";
            var user = new _cometchat_pro_cordova_ionic_chat__WEBPACK_IMPORTED_MODULE_6__["CometChat"].User(uid);
            user.setName(name);
            ...
            _cometchat_pro_cordova_ionic_chat__WEBPACK_IMPORTED_MODULE_6__["CometChat"].login("Superhero1", apiKey).then(function (user) {
                console.log("Login Successful:", { user: user });
                console.log("Login Successful:", JSON.stringify(user));
            }, function (error) {
                console.log("Login failed with exception:", { error: error });
            });
        }, function (error) {
        ...
        var listnerID = "user3";
        _cometchat_pro_cordova_ionic_chat__WEBPACK_IMPORTED_MODULE_6__["CometChat"].addCallListener(listnerID, new _cometchat_pro_cordova_ionic_chat__WEBPACK_IMPORTED_MODULE_6__["CometChat"].CallListener({
            onIncomingCallReceived: function (call) {
                console.log("Incoming call:", call);
                console.log("Incoming call:", JSON.stringify(call));
                // Handle incoming call
                var sessionID = call.sessionId;
                _cometchat_pro_cordova_ionic_chat__WEBPACK_IMPORTED_MODULE_6__["CometChat"].acceptCall(sessionID).then(function (call) {
                    console.log("Call accepted successfully:", call);
                    console.log("Call accepted successfully:", JSON.stringify(call));
                    // start the call using the startCall() method
                    _cometchat_pro_cordova_ionic_chat__WEBPACK_IMPORTED_MODULE_6__["CometChat"].startCall(sessionID, document.getElementById("callScreen"), new _cometchat_pro_cordova_ionic_chat__WEBPACK_IMPORTED_MODULE_6__["CometChat"].OngoingCallListener({
            ...
            onOutgoingCallAccepted: function (call) {
...
module.exports = __webpack_require__(/*! /usr/prjct/various/sample-app-ionic-master/src/main.ts */"./src/main.ts");
