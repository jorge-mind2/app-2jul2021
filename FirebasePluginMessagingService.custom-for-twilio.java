// Reemplazar en lugar de "plugins/cordova-plugin-firebasex/src/android/FirebasePluginMessagingService.java"
...
public class FirebasePluginMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        try{
            ...
            title = data.get(NOTIFY_TITLE_DATA_KEY);
            body = data.get(NOTIFY_BODY_DATA_KEY);
            ...
            if (!TextUtils.isEmpty(body) || !TextUtils.isEmpty(title) || (data != null && !data.isEmpty())) {
                ...
                Log.d(TAG, "FirebasePlugin.defaultChannelId: " + FirebasePlugin.defaultChannelId);
                boolean showNotification = FirebasePlugin.defaultChannelId == null;
